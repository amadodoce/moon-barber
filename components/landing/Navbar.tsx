...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-[#2A2A2A] pt-[env(safe-area-inset-top)]">
      ...
      {menuOpen && (
        <div
          id={menuId}
          className="relative border-t border-[#2A2A2A] bg-[#0A0A0A] px-6 py-4 pb-[calc(1rem+env(safe-area-inset-bottom))] md:hidden"
        >
